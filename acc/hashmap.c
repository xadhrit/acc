// task to learn hashmap  and implement open-addressing hash-table
...
// make room for new enteries in a given hashmap by removing tombstones and possibly extending the bucket size
static void rehash(HashMap *map){
   // Compute the size of new hashmap
   int nkeys = 0;
