...
// UTF-8 encoding => 4 byte code point
// One byte UTF-8 code point = ASCII
...
// C11 does not allow only ASCII but multibyte characters are certain Unicode ranges to be used in identifier;
...
// returns true if a given character is acceptable as a non-first character of an identifier
bool is_ident2(uint32_t c){
   static uint32_t range[] = {
      '0', '9', '$', '$', 0x0300, 0x036F, 0x1DFF, 0x20D0, 0x20FF, 0xFE20, 0xFE2F, -1,
   };
...
// returns the number of columns needed to display a given string in a fixed-width font
